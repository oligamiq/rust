...
// Macro rule span expansion from external crate
pub const EXTERNAL_SP: Span = Span { lo: BytePos(0), hi: BytePos(0), expn_id: EXTERNAL_EXPN };
...
// Macro rule span expansion from external crate
pub const EXTERNAL_EXPN: ExpnId = ExpnId(!3);
